...
def main(argv):
  ...
  if not os.system("hadoop fs -mkdir /user/"+username):
    os.popen("sudo hadoop fs -chmod o-rwx /user/"+username)
  ...
  if argv[1] == 'c' or argv[1] == 'C':
    ...
    if argv[1] == 'n' or argv[1] == 'N':
      ...
      os.popen("sudo hadoop dfsadmin -setSpaceQuota "+argv[1]+" /user/"+username)
  ...
  if argv[2] == 'c' or argv[2] == 'C':
    ...
    if argv[2] == 'n' or argv[2] == 'N':
      ...
      os.popen("sudo hadoop dfsadmin -setQuota "+argv[2]+" /user/"+username)  
